...
("ff.rfe.sensor.rfe51_attenuator_horizontal.get_value()", 3.5, "ff.rfe.req.rfe5_attenuation('rfe51','h',3.5)"),
("ff.rfe.sensor.rfe51_attenuator_vertical.get_value()", 2.5, "ff.rfe.req.rfe5_attenuation('rfe51','v',2.5)"),
("ff.rfe.sensor.rfe52_attenuator_horizontal.get_value()", 4.0, "ff.rfe.req.rfe5_attenuation('rfe52','h',4.0)"),
("ff.rfe.sensor.rfe52_attenuator_vertical.get_value()", 3.5, "ff.rfe.req.rfe5_attenuation('rfe52','v',3.5)"),

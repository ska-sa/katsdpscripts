...
matplotlib.use('Agg')
import argparse
#from katsdpscripts.RTS import diodeib
import diodelib
...
def parse_arguments():
    ...
    parser.add_argument("--rfi_mask",default="/var/kat/katsdpscripts/RTS/rfi_mask.pickle",help="Default is /var/kat/katsdpscripts/RTS/rfi_mask.pickle")
    parser.add_argument("--receptor",default='',help="Receptor number to process e.g. 'm053', default is all")
...
if __name__ == "__main__":
    ...
    diodelib.read_and_plot_data(args.filename[0],args.output_dir,args.pdf,args.Ku,args.verbose,args.error_bars,args.off_target,args.write_nd,args.rfi_mask,args.receptor,**kwargs)

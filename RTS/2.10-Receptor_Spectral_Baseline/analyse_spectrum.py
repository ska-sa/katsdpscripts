...
def plot_RFI_mask(pltobj,extra=None,channelwidth=1e6):
    pltobj.axvspan(1674,1677, alpha=0.3, color='grey')#Meteosat
    pltobj.axvspan(1667,1667, alpha=0.3, color='grey')#Fengun
    pltobj.axvspan(1682,1682, alpha=0.3, color='grey')#Meteosat
    pltobj.axvspan(1685,1687, alpha=0.3, color='grey')#Meteosat
    pltobj.axvspan(1687,1687, alpha=0.3, color='grey')#Fengun
    pltobj.axvspan(1690,1690, alpha=0.3, color='grey')#Meteosat
    pltobj.axvspan(1699,1699, alpha=0.3, color='grey')#Meteosat
    pltobj.axvspan(1702,1702, alpha=0.3, color='grey')#Fengyun
    pltobj.axvspan(1705,1706, alpha=0.3, color='grey')#Meteosat
    pltobj.axvspan(1709,1709, alpha=0.3, color='grey')#Fengun
    pltobj.axvspan(1501,1570, alpha=0.3, color='blue')#Inmarsat
    pltobj.axvspan(1496,1585, alpha=0.3, color='blue')#Inmarsat
    pltobj.axvspan(1574,1576, alpha=0.3, color='blue')#Inmarsat
    pltobj.axvspan(1509,1572, alpha=0.3, color='blue')#Inmarsat
    pltobj.axvspan(1574,1575, alpha=0.3, color='blue')#Inmarsat
    pltobj.axvspan(1512,1570, alpha=0.3, color='blue')#Thuraya
    pltobj.axvspan(1450,1498, alpha=0.3, color='red')#Afristar
    pltobj.axvspan(1652,1694, alpha=0.2, color='red')#Afristar
    pltobj.axvspan(1542,1543, alpha=0.3, color='cyan')#Express AM1
    pltobj.axvspan(1554,1554, alpha=0.3, color='cyan')#Express AM 44
    pltobj.axvspan(1190,1215, alpha=0.3, color='green')#Galileo
    pltobj.axvspan(1260,1300, alpha=0.3, color='green')#Galileo
    pltobj.axvspan(1559,1591, alpha=0.3, color='green')#Galileo
    pltobj.axvspan(1544,1545, alpha=0.3, color='green')#Galileo
    pltobj.axvspan(1190,1217, alpha=0.3, color='green')#Beidou
    pltobj.axvspan(1258,1278, alpha=0.3, color='green')#Beidou
    pltobj.axvspan(1559,1563, alpha=0.3, color='green')#Beidou  
    pltobj.axvspan(1555,1596, alpha=0.3, color='green')#GPS L1  1555 -> 1596 
    pltobj.axvspan(1207,1238, alpha=0.3, color='green')#GPS L2  1207 -> 1248 
    pltobj.axvspan(1378,1384, alpha=0.3, color='green')#GPS L3  
    pltobj.axvspan(1588,1615, alpha=0.3, color='green')#GLONASS  1588 -> 1615 L1
    pltobj.axvspan(1232,1259, alpha=0.3, color='green')#GLONASS  1232 -> 1259 L2
    pltobj.axvspan(1616,1630, alpha=0.3, color='grey')#IRIDIUM

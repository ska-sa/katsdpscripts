...
parser.add_option("--nocross", action='store_true', help="Dont compute flags on cross pols to speed things up.")
...
generate_flag_table(filename,output_root=opts.output_dir,static_flags=opts.static_flags,write_into_input=opts.write_input,nocross=opts.nocross)

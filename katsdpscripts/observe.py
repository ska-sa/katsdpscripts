...
def standard_script_options(usage, description):
    ...
    parser.add_option('-s', '--system',
                    help='System configuration file to use, relative to conf directory '
                    '(default reuses existing connection, '
                    'or falls back to systems/local.conf)')
    ...
    parser.add_option('--schedule-block-id', type='string',
                      help='Schedule block ID for the observation. This is '

...
#   Stationary test: Az=0, El=15. Capture for 5 seconds, preferably with it in E-Stop so it's safe to sit on the indexer.
        
        session.label('scan')
        target1 = katpoint.Target('scan1 - Stationary Az=0 El=16, azel, 0, 16')    

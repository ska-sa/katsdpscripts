...
list_o_names = 'Datasets:'+' ,'.join(np.unique(data['dataset']).tolist() )
fig.text(0.405, 0.96,git_info(get_git_path()), horizontalalignment='right',fontsize=10)
fig.text(0.905, 0.96,list_o_names, horizontalalignment='right',fontsize=10)

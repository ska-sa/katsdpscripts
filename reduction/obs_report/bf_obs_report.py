...
def build_ipynb_bf_obs_report_command(directory, template):
    print directory
    bf_obs_report_template_filename = template
    directory_base = os.path.basename(directory)
    bf_obs_report_output_filename = 'bf_obs_report_%s.ipynb' % directory_base
...
def generate_ipynb_bf_obs_report(directory, template):
    # call obs report
...
generate_ipynb_bf_obs_report(args.directory[0], args.template)

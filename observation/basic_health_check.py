...
("kat.dbe7.sensor.dbe_mode.get_value()",['bc16n400M1k','c16n400M1k','c16n400M8k','c16n2M4k','c16n7M4k','c16n13M4k','c16n25M4k'],'',1,1),
("","","","",""), # creates a blank line
]
...
def show_status_header(kat, opts, selected_sensors):
    ...
    try:
        ...
        if dbe_mode in ['bc16n400M1k','c16n400M1k','c16n2M4k','c16n7M4k','c16n25M4k']:
            dbe_mode_colour = normal_colour
        elif dbe_mode in ['c16n400M8k','c16n13M4k']:

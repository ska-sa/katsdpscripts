...
parser.add_option(
    '--email_to', type='str',
    #default='blunsky@ska.ac.za,bjordaan@ska.ac.za,jvanstaden@emss.co.za,bjordaan@emss.co.za,operators@ska.ac.za,jvanstaden@emss.co.za',
    default='blunsky@ska.ac.za',
...
with verify_and_connect(opts) as kat:
    ...
    if opts.receptors == 'all':
        ant_active = sorted(
            [ant.name for ant in kat.ants if ant.name not in kat.katpool.sensor.resources_in_maintenance.get_value()])
    else:
        ant_active = sorted(

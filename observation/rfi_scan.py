...
if opts.dry_run : user_logger.info("!! Dry run time is not Accurate !!   Assume a time of about 1400 seconds per frequency for the scan. or 70 Miniuts for the default frequency set" )
